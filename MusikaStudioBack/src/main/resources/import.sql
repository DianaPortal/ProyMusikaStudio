INSERT INTO categorias (descripcion, nombre) VALUES ('GUITARRA ELÉCTRICA', 'GUITARRA ELECTRICA');
INSERT INTO categorias (descripcion, nombre) VALUES ('GUITARRA ACÚSTICA', 'GUITARRA ACUSTICA');
INSERT INTO categorias (descripcion, nombre) VALUES ('BAJO', 'BAJO');
INSERT INTO categorias (descripcion, nombre) VALUES ('ARPA', 'ARPA');
INSERT INTO categorias (descripcion, nombre) VALUES ('VIOLÍN', 'VIOLIN');
...
INSERT INTO categorias (descripcion, nombre) VALUES ('BATERÍA ELÉCTRICA', 'BATERIA ELECTRICA');
INSERT INTO categorias (descripcion, nombre) VALUES ('BATERÍA ACÚSTICA', 'BATERIA ACUSTICA');
...
-- GUITARRAS LECTRICAS
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 3199, 0, '2024-11-24', 1, 1, 'Guitarra eléctrica de alta calidad.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraFenderPlayerAnniversary.webp', 'Fender Player Anniversary');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 7899, 0, '2024-11-24', 1, 2, 'Guitarra Gibson estilo clásico.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraGibsonSG.webp', 'Gibson SG');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 1999, 0, '2024-11-24', 1, 4, 'Guitarra eléctrica Yamaha profesional.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraYamahaPacifica.webp', 'Yamaha Pacifica');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 3399, 0, '2024-11-24', 1, 5, 'Guitarra eléctrica Pearl edición limitada.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraPearlCustom.webp', 'Pearl Custom');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 8599, 0, '2024-11-24', 1, 3, 'Guitarra Ibanez diseño moderno.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraIbanezJem.webp', 'Ibanez Jem');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 1200, 10, '2024-11-24', 1, 1, 'Guitarra eléctrica con excelente resonancia.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraFernderStratocaster.jpg', 'Fender Stratocaster');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 5500, 10, '2024-11-24', 1, 2, 'Guitarra de alta calidad ideal para solos.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraGibsonLesPaul.webp', 'Gibson Les Paul');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 2500, 15, '2024-11-24', 1, 3, 'Guitarra eléctrica perfecta para todos los géneros.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraIbanezRG.jpg', 'Ibanez RG');
-- GUITARRAS ACUSTICAS
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 1000, 8, '2024-11-24', 1, 4, 'Guitarra acústica con un sonido claro y brillante.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraYamahaFG800.webp', 'Yamaha FG800');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 600, 5, '2024-11-24', 1, 5, 'Guitarra eléctrica de alta resonancia.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraPearl.webp', 'Pearl');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 900, 10, '2024-11-24', 1, 4, 'Guitarra acústica versátil para cualquier músico.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/GuitarraYamahaA3M.webp', 'Yamaha A3M');
-- BAJOS ELECTRICOS
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 4999, 0, '2024-11-24', 3, 1, 'Bajo eléctrico de excelente resonancia.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoFenderPrecision.webp', 'Fender Precision');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 3099, 0, '2024-11-24', 3, 2, 'Bajo eléctrico estilo vintage.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoGibsonSG.jpg', 'Gibson SG');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 2899, 0, '2024-11-24', 3, 3, 'Bajo de alto rendimiento.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoIbanezSR300.webp', 'Ibanez SR300');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 799, 0, '2024-11-24', 3, 1, 'Bajo eléctrico clásico de Fender.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoFenderJazz.jpg', 'Fender Jazz');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 7299, 0, '2024-11-24', 3, 2, 'Bajo Gibson con cuerpo sólido.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoGibsonThunderbird.jpeg', 'Gibson Thunderbird');
INSERT INTO instrumentos (activo, precio, stock, fecha_ingreso, id_categoria, id_marca, descripcion, imagen, nombre) VALUES (1, 949, 0, '2024-11-24', 3, 3, 'Bajo eléctrico versátil de Ibanez.', 'https://storagemusikastudio.blob.core.windows.net/instrumentos/BajoIbanezGSR200.webp', 'Ibanez GSR200');
-- TECLADOS
